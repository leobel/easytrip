...
public class PDKClient {
    ...
    public void getMyPins(String path, HashMap<String, String> params, PDKCallback callback) {
        getPath(path, params, callback);
    }

    public void getMyPins(String fields, String cursor, PDKCallback callback) {
        String path =  ME + PINS;
